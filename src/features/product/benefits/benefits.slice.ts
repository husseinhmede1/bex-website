...
import { Benefits} from "./benefits.type"; 
...
const benefitsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makeBenefitsApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makeBenefitsApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makeBenefitsApiCall.rejected, (state, action) => {
