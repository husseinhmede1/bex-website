...
import { Challanges } from "./challanges.type";

/**
 * Initial state object
 */
const initialState: Challanges = {};
...
const challangesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makeChallangesApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makeChallangesApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makeChallangesApiCall.rejected, (state, action) => {
 ...
 */
export const challangesReducer = challangesSlice.reducer;
 ...
 */
export const challangesActions = { ...challangesSlice.actions };
