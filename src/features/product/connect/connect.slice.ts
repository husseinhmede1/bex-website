...
import { Connect } from "./connect.type"; 
...
const connectSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makeConnectApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makeConnectApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makeConnectApiCall.rejected, (state, action) => {
