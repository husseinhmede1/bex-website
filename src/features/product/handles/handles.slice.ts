...
import { Handles } from "./handles.type"; 
...
const handlesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makeHandlesApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makeHandlesApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makeHandlesApiCall.rejected, (state, action) => {
 ...
 */
export const handlesReducer = handlesSlice.reducer;
 ...
 */
export const handlesActions = { ...handlesSlice.actions };
