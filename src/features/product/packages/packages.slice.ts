...
const packagesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makePackagesApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makePackagesApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makePackagesApiCall.rejected, (state, action) => {
