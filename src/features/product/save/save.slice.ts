...
const saveSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(makeSaveApiCall.pending, (state, action) => {
      // Write pending logic here
    });
    builder.addCase(makeSaveApiCall.fulfilled, (state, action) => {
      // Write success logic here
    });
    builder.addCase(makeSaveApiCall.rejected, (state, action) => {
